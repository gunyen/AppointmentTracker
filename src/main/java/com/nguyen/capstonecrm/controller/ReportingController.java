...
import com.nguyen.capstonecrm.DAO.ReportDaoImpl;
import com.nguyen.capstonecrm.Scheduler;
import com.nguyen.capstonecrm.helper.Alerts;
import com.nguyen.capstonecrm.helper.OutputReportInterface;
    ...
    public void thirdTab() throws Exception {
        ...
        try {
            ...
            OutputReportInterface output = () -> {
                ...
                if (!file.exists()) {
                    Alerts.alertWarning("Missing log file!","Log file has ran away from home!");
                }
